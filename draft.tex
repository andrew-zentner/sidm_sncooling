...
summarizes a variety of constraints on dark electromagnetism models of SIDM. 
...
\subsection{Brehmsstrahlung of $A'$ Bosons}
...
in more detail below. If all of the $A'$ produced in the core leave the supernova freely, all 
...
this can occur because of either $A'$ decays or $A'$ scattering. These additional considerations place 
...
from the production on $A'$ bosons. In order to function as an effective cooling channel, the 
...
%
\beq
l = \gamma \tau_{\mathrm{A}'} = \frac{3 E_{A}}{N_{eff} m_A^2 \varepsilon^2},
\eeq
