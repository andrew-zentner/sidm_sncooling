...
\section{Computational details}
	simple energy loss calculation 
...
\section{Bremsstrahlung diagrams}
	...
	For $pn$ scattering, four of the diagrams are simply the $ M_1, M_2, M_3, M_4 $ given above, with the only new Feynman diagram coming from bremsstrahlung off the internal pi, resulting in  
	 \beq
	 M'_5 = \frac{4 M_N}{ m_\pi} \frac{f_{pn}^2 e \epsilon}{l^2-m_\pi^2
	 }  \frac{1}{(l-q_a)^2 - m_\pi^2} \bar{u}(p_4) \gamma_5 u(p_1) \bar{u}(p_3) u(p_2) (q_a - 2l)\cdot \varepsilon
	 \eeq
