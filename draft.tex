...
As shown in Fig. ~\ref{fig:temperature}, we have repeated a portion of our calculations after shifting the core temperature by $\pm 5\, \mathrm{MeV}$ and found that the lower boundary of the excluded region shifts by a factor of $\sim 2$ at low 
mass ($m_{\mathrm{A}'} \lesssim T$ where $T = 30\, \mathrm{MeV}$ in our fiducial calculation, following 
work of previous authors) and considerably more at high mass. 
We conclude that the differences among theoretical techniques for 
computing the excluded region (OPE, SRA, ...) lead to uncertainties that are of the same order or 
